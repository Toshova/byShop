<template>
    <div class="block_wrap">
        <div class="header">
            <p class="clr_dark font_xxl">Товары на распродаже</p>
        </div>
        <div class="swiper_wrap">
            <div class="block_items">   
                <swiper ref="mySwiper" :options="swiperOptions6">      
        ...
        <div class="swiper-button swiper-button-prev selectorpr6" slot="button-prev"></div>
        <div class="swiper-button swiper-button-next selectornx6" slot="button-next"></div>    
    </div>
