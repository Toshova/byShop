<template>
    <div class="block_wrap">
        <div class="header">
            <p class="clr_dark font_xxl">Новинки</p>
        </div>
        <div class="filter_menu font_s clr_dark">
            <div class="filter_menu_block">
                <p class="filter_item bgd_lg" v-for="el in filterMenu" :key="el">{{ el}}</p>
            </div>
            <div class="filter_menu_block">
                <p class="filtered"> Показать еще </p>
                <button>
                    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.8594 1.48451L11.1399 0.765015L5.99988 5.90601L0.859375 0.766015L0.140375 1.48451L5.64038 6.98451L5.99988 7.32801L6.35937 6.98451L11.8594 1.48451Z" fill="#19212A"/>
                    </svg>
                </button>
        ...
        <div class="swiper_wrap">
            <div class="block_items">   
                <swiper ref="mySwiper" :options="swiperOptions4">      
                    <swiper-slide v-for="item in items" :key="item.name">   
                        <div class="item">
                            <div class="img_wrap">
                                <img class="card_img" v-bind:src="item.img">
                                <button class="card_icon" @click ="item.liked = !item.liked">
                            ...
                            <div class="item_info">
                                ...
                                <p class="clr_dar font_xl item_price">{{ item.price }} сўм</p>
                                
                            </div>
                            
                           <div class="btn_wrap">
                                <button class="main_btn">
                                    <img src="/bascet.svg" alt="">
                                    В корзину
                                </button>
                           </div>
        ...
        <div class="swiper-button swiper-button-prev selectorpr4" slot="button-prev"></div>
        <div class="swiper-button swiper-button-next selectornx4" slot="button-next"></div>    
    </div>
