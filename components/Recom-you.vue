<template>
    <div class="block_wrap">
        <div class="header">
            <p class="clr_dark font_xxl">Рекомендуем Вам</p>
        </div>
        <div class="swiper_wrap">
            <div class="block_items">   
                <swiper ref="mySwiper" :options="swiperOptions5">      
        ...
        <div class="swiper-button swiper-button-prev selectorpr5" slot="button-prev"></div>
        <div class="swiper-button swiper-button-next selectornx5" slot="button-next"></div>    
    </div>
